...
Консольное приложение на Python, убирает перспективные искажения на фотографиях зданий. Вертикальные линии фасада разъезжаются из-за наклона камеры, программа их выпрямляет.
...
```bash
git clone https://github.com/Zarina-Amirova/rectify.git
cd rectify
python -m venv rectify-env
...
| До  (c vp и линиями)| После ректификации |
|---|---|
...
### Обозначения на картинке "до (c vp и линиями)"
